...
set_C="ccache clang --target=aarch64-linux-musl -O2 -march=armv8.2-a+lse+crypto+dotprod -mcpu=cortex-a77 -flto=thin -Wno-error -ffunction-sections -fdata-sections"
set_HOSTC="ccache clang -O2 -flto=thin -Wno-error -ffunction-sections -fdata-sections"
